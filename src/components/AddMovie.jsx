  ...
  return (
    <div className="bg-purple-100 py-10">
      <div className="max-w-3xl mx-auto bg-base-100 p-6 rounded-xl shadow-lg">
        <h2 className="text-2xl font-bold text-center mb-6">Add a New Movie</h2>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="form-control">
            <label className="label">
              <span className="text-lg font-medium">Movie Poster URL</span>
            </label>
            <input
              type="text"
            ...
            />
            {errors.poster && (
              <p className="text-error text-sm mt-1">{errors.poster.message}</p>
            )}
          </div>
          <div>
